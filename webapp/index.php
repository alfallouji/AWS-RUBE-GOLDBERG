...
?>
                            ...
                            <p class="lead">Your first step is to <a href="?action=deactivate">deactivate the S3 replication</a> and replace it with your own Rube Goldberg Machine. You have to make sure that the message in the input bucket ultimately gets delivered in the output bucket. Make sure to read the rules of engagement below.</p>
                            <img src="img/3.png" />
