...
<html>
    <head>
        <style>
            ...
            img { padding: 20px !important; margin-bottom:20px; }
            .list-group-item {
...
?>
                            ...
                            <p class="lead">A simple RBM - send a message via this webapp that will get automatically replicated from one S3 bucket to another.</p>
                            <img src="img/1.png" />
                            
                            <p class="lead">Then, use this webapp to check the replicated version.</p>
                            <img src="img/2.png" />

                            <h1>Create your own Rube Goldberg Machine in AWS</h1>
                            <p class="lead"><a href="?action=replication">Deactivate the S3 replication</a> and replace it with your own RBM.</p>
                            <img src="img/3.png" />
                            
                            <h1>Rules of engagement</h1>
                            <div class="panel panel-primary">
                              <!-- Default panel contents -->
                              <div class="panel-heading">The ten commandments - If you want to win this contest, it is important to respect the following rules.</div>
                            
                              <!-- List group -->
                              <ol class="list-group">
                                <li class="list-group-item">Each AWS services used will give your team 10 points. Using the exact same service several times will not give you any additional points (with the exception of the services used by the initial RBM).</li>
                                <li class="list-group-item">There is a maximum execution time of 15 minutes for your Rube Goldberg Machine. You will loose all points if it takes more time for your message to show up.</li>
                                ...
                                <li class="list-group-item">Every team starts with 0 point. Again, the services used by the initial RBM do not count (e.g. S3, EC2 instance). Therefore, you will get points if you use them again.</li>
